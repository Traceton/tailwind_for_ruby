require_relative 'lib/tailwind_for_ruby/version'
...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{a tailwind ui generator for internal use}
  spec.description   = %q{a tailwind ui generator for internal use}
